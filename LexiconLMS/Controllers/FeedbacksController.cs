...
namespace LexiconLMS.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ApplicationUserId,ActivityId,Message,PostedDate,IsPostedByTeacher")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ApplicationUserId,ActivityId,Message,PostedDate,IsPostedByTeacher")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
